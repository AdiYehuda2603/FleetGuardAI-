...
class EmailFetcher:
    ...
    def _encode_imap_utf7(self, folder_name: str) -> str:
        ...
        # Encode to IMAP modified UTF-7 using a proven algorithm
        try:
            import base64

            # Modified UTF-7 encoding for IMAP (RFC 3501)
            # & is shift character, - ends shift, use base64 with comma instead of slash
